...
public class KafkaSpoutWrapper extends KafkaSpout implements ISpoutSpecLCM {
    ...
    public void open(Map conf, final TopologyContext context, final SpoutOutputCollector collector) {
        ...
        if (_spoutConfig.hosts instanceof StaticHosts) {
            _coordinator = new StaticCoordinator(_connections, conf, _spoutConfig, _state, context.getThisTaskIndex(), totalTasks, context.getThisTaskId(), topologyInstanceId);
        } else {
            _coordinator = new ZkCoordinator(_connections, conf, _spoutConfig, _state, context.getThisTaskIndex(), totalTasks, context.getThisTaskId(), topologyInstanceId);
        }
